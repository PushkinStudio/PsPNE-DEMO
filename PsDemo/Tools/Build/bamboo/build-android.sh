...
export JAVA_OPTS="-Xms10g -Xmx12g $JAVA_OPTS"
JAVA_OPTS="-Xms10g -Xmx12g $JAVA_OPTS"
SUPPORTED_TEXTURES=ETC2
...
./Engine/Build/BatchFiles/RunUAT.command BuildCookRun \
   ...
   -clientconfig=${bamboo_COOK_CLIENTCONFIG} -seconfig=${bamboo_COOK_SERVERCONFIG} -utf8output -platform=Android \
   -targetplatform=Android -cookflavor=${SUPPORTED_TEXTURES} \
